Извините за недочет! Если вам нужно разделить код на более структурированные файлы, например, с использованием заголовочных файлов (`.h`), я добавлю их в проект. 
